...
export const RPC_METHODS: Record<string, Handler> = {
  ...
  upload: (cf, a, ev) => cf.upload(a.site, a.local, a.remote, ev, { cwd: a.cwd }),
  download: (cf, a, ev) => cf.download(a.site, a.remote, a.local, ev),
  uploadMany: (cf, a, ev) => cf.uploadMany(a.site, a.locals, a.remote, ev, { cwd: a.cwd }),
  downloadMany: (cf, a, ev) => cf.downloadMany(a.site, a.remotes, a.local, ev),
  removeMany: (cf, a, ev) => cf.removeMany(a.site, a.paths, ev),
  ...
  undo: (cf, a, ev) => cf.undo(a.cwd, { site: a.site, to: a.to, message: a.message, dryRun: a.dryRun }, ev),
  verify: (cf, a, ev) => cf.verify(a.cwd, { site: a.site, paths: a.paths }, ev),
